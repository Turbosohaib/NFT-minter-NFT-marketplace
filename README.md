...
```
dfx canister call opend listItem '(principal "<PASTE NEW NFT ID>", 2)'
```
...
```
dfx canister call <PASTE NEW NFT ID> transferOwnership '(principal "<PASTE CANISTER ID>", true)'
```
